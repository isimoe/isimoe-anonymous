...
try:
    from src.common.modules.moe import FMoETransformerMLP
    _FMOE_IMPORT_ERROR = None
except ImportError as exc:
    FMoETransformerMLP = None
    _FMOE_IMPORT_ERROR = exc
        ...
        **kwargs,
        ...
        if self.mlp_sparse:
            if FMoETransformerMLP is None:
                raise ImportError(
                    "Sparse fusion requires FasterMoE. Install it for the active "
                    "PyTorch/CUDA environment or set --fusion_sparse False."
                ) from _FMOE_IMPORT_ERROR
